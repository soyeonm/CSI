...
def main_objclr():
	...
	objclr.train(train_loader, permclr_train_datasets, test_datasets, just_average=True, train_batch_size=args.eval_train_batch_size, class_lens = len(classes), eval_period = 5, train_sampler=train_sampler)
