...
def main_objclr():
	...
	train_dataset = ObjDataset(train_root_dir, args.object_views,  transform=ContrastiveLearningViewGenerator(get_simclr_pipeline_transform(args.co3d_cropsize, 1, args.resize_co3d, crop_from=args.crop_from), 2), processed=processed, mask=args.mask_crop, globs=train_glob) #transform can be None too
	...
	if args.local_rank ==0:
		...
		permclr_train_dataset = ObjInferenceDataset(train_root_dir, args.object_views, resize_shape= args.resize_co3d, shots=args.eval_train_batch_size,  transform=None, processed=processed,  mask=args.mask_crop, globs=train_glob)
		...
		test_dataset = ObjInferenceDataset(test_root_dir, args.object_views, resize_shape= args.resize_co3d, shots=None,  transform=None, processed=True, class_idx=train_class_idx, mask=args.mask_crop, globs=test_glob)
