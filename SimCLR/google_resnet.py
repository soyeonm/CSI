...
class get_contrastive_resnet(nn.Module):
	def __init__(self, resnet_model, contrastive_head_model):
		super().__init__()
		self.resnet_model = resnet_model
		self.contrastive_head_model = contrastive_head_model
	#
	def forward(self,x):
		return self.contrastive_head_model(self.resnet_model(x))
